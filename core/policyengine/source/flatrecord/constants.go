...
const (
	...
	SF_PROC_CAP_PERMITTED   string = "sf.proc.thread_cap_permitted"
	SF_PROC_CAP_EFFECTIVE   string = "sf.proc.thread_cap_effective"
	SF_PROC_CAP_INHERITABLE string = "sf.proc.thread_cap_inheritable"
	...
	SF_POD_TS               string = "sf.pod.ts"
	SF_POD_ID               string = "sf.pod.id"
	SF_POD_NAME             string = "sf.pod.name"
	SF_POD_NODENAME         string = "sf.pod.nodename"
	SF_POD_NAMESPACE        string = "sf.pod.namespace"
	SF_POD_RESTARTCOUNT     string = "sf.pod.restartcnt"
	SF_POD_HOSTIP           string = "sf.pod.hostip+"
	SF_POD_HOSTIP_JSON      string = "sf.pod.hostip"
	SF_POD_INTERNALIP       string = "sf.pod.internalip+"
	SF_POD_INTERNALIP_JSON  string = "sf.pod.internalip"
	SF_POD_SERVICES         string = "sf.pod.services+"
	SF_POD_SERVICES_JSON    string = "sf.pod.services"
	SF_K8SE_ACTION          string = "sf.ke.action"
	SF_K8SE_KIND            string = "sf.ke.kind"
	SF_K8SE_MESSAGE         string = "sf.ke.message"
